...
/*    vmode    hht     hbb     hbe     hdb     hde     hss     vft     vbb     vbe     vdb     vde     vss         UMA*/
#ifdef FALCON_800
    { 0x001a,  0x00fc, 0x00b4, 0x001a, 0x02de, 0x009b, 0x00c0, 0x0419, 0x03ff, 0x002f, 0x002f, 0x03ef, 0x0415 }, /*UMA*/
#else
    { 0x001a,  0x00c6, 0x008d, 0x0015, 0x02a3, 0x007c, 0x0096, 0x0419, 0x03ff, 0x003f, 0x003f, 0x03ff, 0x0415 },
#endif
/*    vmode    hht     hbb     hbe     hdb     hde     hss     vft     vbb     vbe     vdb     vde     vss         UMA*/
#ifdef FALCON_800
    { 0x001b,  0x00fc, 0x00b4, 0x001a, 0x02e6, 0x00a3, 0x00c1, 0x0419, 0x03ff, 0x002f, 0x002f, 0x03ef, 0x0415 }, /*UMA*/
#else
